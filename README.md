...
### デイリーアップデート（毎日 7:30 JST 前後、9:00までの完了を目標）
...
4. ビジネスホットトピック / 5. コミュニティイベント情報（東京・神奈川）および大手ベンダー・大規模カンファレンス
（1〜4 は各 5〜6 トピック、読了目安 約10分）
...
フィードのドメイン、ecosystem identifier、PyPI のみへアクセスできます（記事執筆はエージェントが行うため、
